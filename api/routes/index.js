 ...
 * /students/{id}:
 * get:
 * summary: Obter detalhes de um aluno específico (CORREÇÃO DE ERRO 404)
 * tags: [Alunos]
 * parameters:
 * - in: path
 * name: id
 ...
 */
router.get('/students/:id', verifyToken, userController.getStudentById); // <--- ROTA REINSERIDA AQUI
